...
namespace Toyalist1
{
    ...
    // Configurer le gestionnaire des utilisateurs d'application qui est utilisé dans cette application.
    ...
    // Configurer le gestionnaire de connexions d'application qui est utilisé dans cette application.  
